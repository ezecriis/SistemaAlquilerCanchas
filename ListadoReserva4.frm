...
Begin VB.Form ListadoReserva4 
   Caption         =   "Reserva Voley"
   ClientHeight    =   4065
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   8460
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
      Bindings        =   "ListadoReserva4.frx":0000
      Height          =   2175
      Left            =   240
      TabIndex        =   1
      Top             =   480
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"ListadoReserva4.frx":0015
      OLEDBString     =   $"ListadoReserva4.frx":00B3
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "ConsultaPrecio4"
      Caption         =   "Adodc1"
   ...
   End
End
Attribute VB_Name = "ListadoReserva4"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub BtnVolv_Click()
ListadoReserva4.Hide
Voley.Show
End Sub
