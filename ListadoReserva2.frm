...
Begin VB.Form ListadoReserva2 
   Caption         =   "Reserva Basquet"
   ClientHeight    =   3975
   ClientLeft      =   60
   ClientTop       =   405
   ClientWidth     =   9000
   ...
   Begin MSHierarchicalFlexGridLib.MSHFlexGrid MSHFlexGrid1 
      Bindings        =   "ListadoReserva2.frx":0000
      Height          =   2175
      Left            =   240
      TabIndex        =   1
      Top             =   360
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"ListadoReserva2.frx":0015
      OLEDBString     =   $"ListadoReserva2.frx":00B3
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "ConsultaPrecio2"
      Caption         =   "Adodc1"
   ...
   End
End
Attribute VB_Name = "ListadoReserva2"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub BtnVolv_Click()
ListadoReserva2.Hide
Basquet.Show
End Sub
